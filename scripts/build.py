    ...
    for bin_file in filelist:
        if bin_file[-4:]==".bin" and "_partitions.bin" not in bin_file:
            ...
            if isbinfile_esp32(bin_file):
                if ("ABCVP4-SHIELD-V1" in bin_file):
                ...
                elif ("ABCVP4-SHIELD-V2" in bin_file):
                    ...
                    if(("_16." in bin_file) or ("_0.16." in bin_file) or ("_17." in bin_file) or ("_18." in bin_file) or ("_19." in bin_file) or ("_20." in bin_file)):
                        template_filename="./scripts/manifest_esp32_template_tasmota_V43V73.json"
                    else:
...
dict["WEBTOOLMODULE"]='https://unpkg.com/esp-web-tools@10.1.1/dist/web/install-button.js?module'
